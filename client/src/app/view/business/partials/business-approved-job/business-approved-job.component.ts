...
@Component({
  selector: 'app-business-approved-job',
  templateUrl: './business-approved-job.component.html',
  styleUrls: ['./business-approved-job.component.scss']
})
export class BusinessApprovedJobComponent implements OnInit {
  ...
  ngOnInit() {
    window.scrollTo(0, 0);
    this.fetchAllBusinessJobs(true, true);
  }
